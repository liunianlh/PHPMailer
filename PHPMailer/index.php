...
function send_mail_by_smtp($address, $subject, $body, $file = '')
{
  ...
  $mail->Host ='ssl://smtp.exmail.qq.com';                         // SMTP邮箱域名
  $mail->SMTPAuth = true;                               // 启用SMTP验证功能
  $mail->Username = "order@tonetron.com.cn";                    // 邮箱用户名(完整email地址)
  $mail->Password = "Tt2019";                            // smtp授权码，非邮箱登录密码
  $mail->Port = 465;
...
$path = '.\wpic907.jpg';
$ret = send_mail_by_smtp('1205177965@qq.com', 'PHPMailer邮件标题', 'PHPMailer邮件内容', $path);
echo $ret;
